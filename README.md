...
- 파이프라인 테스트 EC2: 장기 중지와 사용 근거 부재를 확인해 담당자 판단 전 편입 보류
...
1. 파이프라인 테스트 EC2의 보존 데이터·재사용 계획을 담당자에게 확인
...
파이프라인 테스트 EC2의 편입 보류 근거와 팀 확인 항목은 [파이프라인 테스트 EC2 관리 판단](docs/assess-pipeline-ec2.md) 참조.
